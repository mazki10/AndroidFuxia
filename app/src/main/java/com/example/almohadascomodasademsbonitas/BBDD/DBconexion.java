...
public class DBconexion extends SQLiteOpenHelper {
    ...
    String sqlCreatePAR = "CREATE TABLE PARTNERS (ID_PARTNER INTEGER, NOMBRE TEXT, CIF TEXT, DIRECCION TEXT, TELEFONO INTEGER, COMERCIAL TEXT, EMAIL TEXT, ZONA INTEGER, FECHA DATE, FOREIGN KEY(COMERCIAL) REFERENCES COMERCIALES(DNI))";
    String sqlCreateAGE = "CREATE TABLE AGENDA (ACTIVIDAD INTEGER, TITULO TEXT, DESCRIPCION TEXT, FECHA TEXT, HORA TEXT)";
    ...
    private void insertarDatosIniciales(SQLiteDatabase db) {
       ...
       // ArrayList<Partner> partners = new ArrayList<>();
        ...
        LogIn.add(new InicioSesion("comercial1", "fuxia123", false, "72555354Z"));
        LogIn.add(new InicioSesion("comercial2", "fuxia123", false, "63287455G"));
        LogIn.add(new InicioSesion("comercial3", "fuxia123", false, "36398612L"));
